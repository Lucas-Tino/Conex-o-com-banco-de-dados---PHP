...
<body class="bg-secondary-subtle">
    ...
    <div class="container bg-light rounded px-4 pt-3">
        <h1>Excluir</h1>
        <p class="fs-5">Deseja realmente apagar este registro?</p>
        <?php 
        ...
        <form method="POST" action="controller/pessoaController.php?acao=excluir&id=<?php echo $pessoa['id']; ?>">
            <div class="form-group mb-3">
                ...
                <input type="text" disabled class="form-control fs-6" id="nome" name="nome" value="<?php echo $pessoa['nome'];?>">
            </div>


            <div class="form-group mb-3">
                <label for="endereco" class="fs-6">Endereço:</label>
                <input type="text" disabled class="form-control fs-6" id="endereco" name="endereco" value="<?php echo $pessoa['endereco'];?>">
            </div>


            <div class="form-group mb-3">
                <label for="bairro" class="fs-6">Bairro:</label>
                <input type="text" disabled class="form-control fs-6" id="bairro" name="bairro" value="<?php echo $pessoa['bairro'];?>">
            </div>


            <div class="form-group mb-3">
                <label for="cep" class="fs-6">CEP:</label>
                <input type="text" disabled class="form-control fs-6" id="cep" name="cep" value="<?php echo $pessoa['cep'];?>">
            </div>


            <div class="form-group mb-3">
                <label for="cidade" class="fs-6">Cidade:</label>
                <input type="text" disabled class="form-control fs-6" id="cidade" name="cidade" value="<?php echo $pessoa['cidade'];?>">
            </div>


            <div class="form-group mb-3">
                <label for="estado" class="fs-6">Estado:</label>
                <input type="text" disabled class="form-control fs-6" id="estado" name="estado" value="<?php echo $pessoa['estado'];?>">
            </div>


            <div class="form-group mb-3">
                <label for="telefone" class="fs-6">Telefone:</label>
                <input type="text" disabled class="form-control fs-6" id="telefone" name="telefone" value="<?php echo $pessoa['telefone'];?>">
            </div>


            <div class="form-group mb-3">
                <label for="celular" class="fs-6">Celular:</label>
                <input type="text" disabled class="form-control fs-6" id="celular" name="celular" value="<?php echo $pessoa['celular'];?>">
            </div>
